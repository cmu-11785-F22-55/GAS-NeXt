...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--preprocess", type=str, default="resize_and_crop", help="not implemented"
        )
        parser.add_argument(
            "--dataset_mode", type=str, default="aligned", help="aligned,single"
        )
        parser.add_argument(
            "--model",
            type=str,
        ...
        parser.add_argument(
            "--num_threads", default=4, type=int, help="# sthreads for loading data"
        )
        parser.add_argument(
            "--checkpoints_dir",
            type=str,
        ...
        parser.add_argument(
            ...
            type=str,
            default="basic_256_multi",
            help="selects model to use for netD2",
        )
        parser.add_argument(
            "--netG", type=str, default="unet_256", help="selects model to use for netG"
        )
        parser.add_argument(
            "--netE",
            type=str,
