...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--direction",
            type=str,
            default="english2chinese",
            help="define the style transfer direction, note that evaluate script does not support chinese2english mode",
        )
        parser.add_argument(
