...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--few_size", type=int, default=7, help="complete set size for few shot"
        )
        ...
        parser.add_argument(
            ...
            type=str,
            default="aligned",
            help="multi_fusion,aligned,single",
        )
        parser.add_argument(
            "--model",
            type=str,
        ...
        parser.add_argument(
            ...
            type=str,
            default="AtoB",
            help="AtoB or BtoC or AtoC, A base B gray C color."
        ...
        parser.add_argument(
            "--num_threads", default=20, type=int, help="# sthreads for loading data"
        )
        parser.add_argument(
            "--checkpoints_dir",
            type=str,
        ...
        parser.add_argument(
            "--vgg",
            type=str,
            default="./models/vgg19-dcbb9e9d.pth",
        ...
        parser.add_argument(
            "--vgg_font",
            type=str,
            default="./models/vgg_font.pth",
            help="fine-tuned vgg in font dataset",
        )

        parser.add_argument(
            "--num_Ds", type=int, default=2, help="number of Discrminators"
        )
        parser.add_argument("--gan_mode", type=str, default="lsgan", help="dcgan|lsgan")
        parser.add_argument(
            "--netD", type=str, default="basic_64", help="selects model to use for netD"
        )
        parser.add_argument(
            "--netD_B",
            type=str,
        ...
        parser.add_argument(
            "--netD_local", type=str, default="basic_32", help="local D"
        )
        parser.add_argument(
            "--netG", type=str, default="agisnet", help="selects model to use for netG"
        )
        ...
        parser.add_argument(
            "--upsample", type=str, default="basic", help="basic | bilinear"
        )
        parser.add_argument(
            "--nl",
            type=str,
        ...
        parser.add_argument(
            "--use_attention", action="store_true", help="if use self attention in G"
        )
        parser.add_argument(
            "--use_spectral_norm_G",
            action="store_true",
        ...
        parser.add_argument(
            "--conditional_D", action="store_true", help="if use conditional GAN for D"
        )
        parser.add_argument(
            "--init_type",
            type=str,
        ...
        parser.add_argument(
            "--wandb_key",
            type=str,
            default="ec10b740c0a116fa604060cad8e84f386810919d",
            help="wandb API key",
        )
